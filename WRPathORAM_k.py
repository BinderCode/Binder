...
def main():
    ...
    for depth in depths:
        ...
        for i in range(iterations):
            oram = PathORAM(depth=depth, storage_dir=storage_directory)
        ...
        csv_file_path = f'WRPathORAM_times_depth_{depth}.csv'
        ...
        print(f"Operation times for depth {depth} saved to {csv_file_path}")
